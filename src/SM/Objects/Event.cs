...
namespace IIS.SM
{
    ...
    public class Event : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.SM.tEventType fEventType;
        ...
        private IIS.SM.ServiceProvider fServiceProvider;
        ...
        public virtual IIS.SM.tEventType EventType
        {
            get
            {
                ...
                IIS.SM.tEventType result = this.fEventType;
        ...
        [NotNull()]
        public virtual IIS.SM.ServiceProvider ServiceProvider
        {
            get
            {
                ...
                IIS.SM.ServiceProvider result = this.fServiceProvider;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View EventE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("EventE", typeof(IIS.SM.Event));
                }
            }
            ...
            public static ICSSoft.STORMNET.View EventL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("EventL", typeof(IIS.SM.Event));
                }
            }
        }
    }
