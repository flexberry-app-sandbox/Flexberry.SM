...
namespace IIS.SM
{
    ...
    public class Ticket : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.SM.Customer fCustomer;
        
        private IIS.SM.DetailArrayOfTicketPosition fTicketPosition;
        ...
        [NotNull()]
        public virtual IIS.SM.Customer Customer
        {
            get
            {
                ...
                IIS.SM.Customer result = this.fCustomer;
        ...
        public virtual IIS.SM.DetailArrayOfTicketPosition TicketPosition
        {
            get
            {
                ...
                {
                    this.fTicketPosition = new IIS.SM.DetailArrayOfTicketPosition(this);
                }
                IIS.SM.DetailArrayOfTicketPosition result = this.fTicketPosition;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View TicketE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TicketE", typeof(IIS.SM.Ticket));
                }
            }
            ...
            public static ICSSoft.STORMNET.View TicketL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TicketL", typeof(IIS.SM.Ticket));
                }
            }
        }
    }
